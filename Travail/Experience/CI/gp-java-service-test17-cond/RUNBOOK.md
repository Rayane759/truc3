# Runbook — gp-java-service-test17-cond

Ce document décrit les procédures opérationnelles du service `my-service-java-test17-cond`.  
...
| Propriété       | Valeur                                      |
|-----------------|---------------------------------------------|
| Service         | gp-java-service-test17-cond                          |
...
```bash
argocd app sync my-service-java-test17-cond
```

### Redémarrer un pod

```bash
kubectl rollout restart deployment/my-service-java-test17-cond -n <NAMESPACE>
```

### Vérifier l'état du service

```bash
kubectl get pods -n <NAMESPACE> -l app=my-service-java-test17-cond
...
```bash
kubectl logs -f deployment/my-service-java-test17-cond -n <NAMESPACE>
```
...
argocd app history my-service-java-test17-cond

# Revenir à une révision précédente
argocd app rollback my-service-java-test17-cond <REVISION>
```
